...
const featuredProjects = [
    ...
    },
    {
        ...
        introText: "How I conducted ethnographic research for an Asian robot vacuum company to uncover US users' household cleaning needs in as a user researcher.",
        buttonText: "VIEW CASE STUDY",
