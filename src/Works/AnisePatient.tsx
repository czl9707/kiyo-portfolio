...
function AnisePatient() {
    ...
    return (
        <ThemeProvider theme={localTheme}>
            ...
            <Catagorize id="overview" catagoryName="Overview">
                <Section> <Overview /> </Section>
            </Catagorize>

            <Catagorize id="problems" catagoryName="Problems">
                <Section> <Problems /> </Section>
            </Catagorize>

            <Catagorize id="bussiness-goal" catagoryName="Business Goal & Constraints">
                <Section color="success"> <BussinessGoal /> </Section>
            </Catagorize>

            <Catagorize id="process" catagoryName="Process">
                <Section color="secondary"> <Process /> </Section>
            </Catagorize>

            <Catagorize id="final-design" catagoryName="Final Design">
                <Section> <FinalDesign /> </Section>
            </Catagorize>

            <Catagorize id="impact" catagoryName="Impact">
                <Section color="success"> <Impact /> </Section>
            </Catagorize>

            <Section color="primary"> <DiveDeeper /> </Section>

            <CatagorizeGroup catagoryName="Round 1">
                <Catagorize id="round1-research" catagoryName="Research">
                    <Section> <Round1 /> </Section>
                </Catagorize>

                <Catagorize id="round1-design1" catagoryName="Design 1">
                    <Section color="secondary"> <Design1 /> </Section>
                </Catagorize>

                <Catagorize id="round1-design2" catagoryName="Design 2">
                    <Section> <Design2 /> </Section>
                </Catagorize>

                <Catagorize id="round1-design3" catagoryName="Design 3">
                    <Section color="secondary"> <Design3 /> </Section>
                </Catagorize>

                <Catagorize id="round1-impact" catagoryName="Impact">
                    <Section color="success"> <Round1Impact /> </Section>
                </Catagorize>
            </CatagorizeGroup>

            <CatagorizeGroup catagoryName="Round 2">
                <Catagorize id="round2-research" catagoryName="Research">
                    <Section> <Round2 /> </Section>
                </Catagorize>

                <Catagorize id="round2-design-iter1" catagoryName="Design Iteration 1">
                    <Section color="secondary"> <DesignIteration1 /> </Section>
                </Catagorize>

                <Catagorize id="round2-design-iter2" catagoryName="Design Iteration 2">
                    <Section> <DesignIteration2 /> </Section>
                </Catagorize>
            ...
            <Section color="primary"> <FinalThoughts /> </Section>

            <Catagorize id="final-thoughts" catagoryName="Final Thoughts">
