...
function EdgemereFarm() {
    ...
    return (
        <ThemeProvider theme={localTheme}>
            ...
            <Catagorize id="problem" catagoryName="Problem">
                <Section color="secondary"> <ProblemStatement /> </Section>
            </Catagorize>

            <Catagorize id="final-delivery" catagoryName="Final Delivery">
                <Section> <FinalDelivery /> </Section>
            </Catagorize>

            <Section color="primary"> <DiveDeeper /> </Section>

            <CatagorizeGroup catagoryName="Research">
                <Catagorize id="research-overview" catagoryName="Research Overview">
                    <Section> <ResearchOverview /> </Section>
                </Catagorize>

                <Catagorize id="target-audience" catagoryName="Target Audience">
                    <Section> <EcosystemMapAndTargetAudience /> </Section>
                </Catagorize>

                <Catagorize id="insights-design-strategy" catagoryName="Insights & Design Strategy">
                    <Section> <KeyInsightsAndDesignStrategy /> </Section>
                </Catagorize>

                <Catagorize id="user-journey" catagoryName="User Journey">
                    <Section> <UserJourney /> </Section>
                </Catagorize>
            </CatagorizeGroup>

            <Catagorize id="design-sketch-testing" catagoryName="Design Sketch & Testing">
                <Section> <DesignSketchAndUserTesting /> </Section>
            </Catagorize>

            <Catagorize id="high-fidelity-prototypes" catagoryName="High-fidelity Prototypes">
                <Section color="secondary"> <FinalDesign /> </Section>
            </Catagorize>

            <Section color="primary"> <FinalThoughts /> </Section>

            <Catagorize id="final-reflections" catagoryName="Final Reflections">
